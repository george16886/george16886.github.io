...
function bot_ui_ini() {
  ...
  botui.message.add({ delay: 800, content: "Hi, there 👋👋👋" }).then(function () {
    botui.message
      .add({ delay: 1100, content: "This is george16886" })
      .then(function () {
        botui.message
          .add({ delay: 1100, content: "You can call me 就幾" })
          .then(function () {
            botui.action
              .button({
                delay: 1600,
  ...
  var sure = function () {
      ...
      botui.message.add({
        delay: 600,
        content:
          // "![...](/uploads/images/cry.gif)",
          "![...](https://i.imgur.com/rhYzL3B.gif)",
      });
    },
    secondpart = function () {
      botui.message
        .add({ delay: 1500, content: "我想想該說啥..." })
        .then(function () {
          botui.message
            .add({
              delay: 600,
            ...
            .then(function () {
              botui.message
                .add({ delay: 1500, content: "我來自台灣🇹🇼 太平洋上一座美麗的小島🏝️" })
                .then(function () {
                  botui.message
                    .add({
                      delay: 1500,
                      content:
                        "興趣是打籃球🏀 但好久沒打😓 好像也可以退休了😰",
                    })
                    .then(function () {
                      botui.message
                        .add({
      ...
      botui.message
        ...
        .then(function () {
          botui.action
            .button({
              delay: 1500,
              action: [{ text: "是因為身高體重嗎? 😂😂😂", value: "why-cat" }],
            })
            .then(function (a) {
              fourthpart();
            });
    ...
    fifthpart = function () {
      botui.message
        .add({ delay: 1e3, content: "不要管為什麼了! 😤 我就是 george16886!" })
        .then(function () {
          botui.message.add({
            delay: 1600,
            content: "歡迎多來坐坐~ 有空可以去留言板留下您的足跡唷! 😍😍😍",
          });
        });
    };
}
